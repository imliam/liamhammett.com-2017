<div class="flex items-center">
    <a href="https://github.com/ImLiam" class="md:ml-auto text-gray-400 hover:text-github py-2 px-2 no-underline">
    ...
    <a href="https://twitter.com/LiamHammett" class="text-gray-400 hover:text-twitter py-2 px-2 no-underline">
    ...
    <a href="https://medium.com/@liamhammett" class="hidden text-gray-400 hover:text-medium py-2 px-2 no-underline">
        <svg aria-hidden="true" alt="Medium" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6">
    ...
    <a href="mailto:liam@liamhammett.com" class="text-gray-400 hover:text-gray-600 py-2 px-2 no-underline">
    ...
    <a href="https://dribbble.com/LiamHammett" class="hidden text-gray-400 hover:text-dribbble py-2 px-2 no-underline">
        <svg aria-hidden="true" alt="Dribbble" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-6">
    ...
    <a href="https://stackoverflow.com/users/3175119" class="hidden text-gray-400 hover:text-stack-overflow py-2 px-2 no-underline">
        <svg aria-hidden="true" alt="Stack Overflow" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="w-6">
